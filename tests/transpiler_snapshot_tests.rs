...
fn test_val_declarations() {
    snapshot_with_configs("val_declarations", r#"val x = 42
val y = "hello"
val z = true"#);
}
...
fn test_function_declarations() {
    snapshot_with_configs("function_declarations", r#"fun add(a: I64, b: I64) {
    return a + b
}
...
fn test_binary_operators() {
    snapshot_with_configs("binary_operators", r#"val sum = 1 + 2
val diff = 10 - 5
val product = 3 * 4
val quotient = 20 / 5
val remainder = 17 % 5"#);
...
fn test_comparison_operators() {
    snapshot_with_configs("comparison_operators", r#"val x = 10
val y = 20
val eq = x == y
val ne = x != y
val lt = x < y
...
fn test_migration_example() {
    ...
    let veltrano_code = fs::read_to_string(veltrano_path)
        .expect("Failed to read basic.vl");
