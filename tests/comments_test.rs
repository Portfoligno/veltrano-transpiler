...
fn test_raw_content() {
    ...
    let block_comment = Comment::new("/* test */".to_string(), "".to_string(), CommentStyle::Block);
...
fn test_raw_content_without_delimiters() {
    ...
    let line_comment = Comment::new("test comment".to_string(), "".to_string(), CommentStyle::Line);
    assert_eq!(line_comment.raw_content(), "test comment");

    let block_comment = Comment::new("test block".to_string(), "".to_string(), CommentStyle::Block);
...
fn test_to_block_style() {
    ...
    let line_comment2 = Comment::new("plain comment".to_string(), "".to_string(), CommentStyle::Line);
    let block2 = line_comment2.to_block_style();
    assert_eq!(block2.content, "/* plain comment */");

    // Test that block comments are unchanged
    let block_comment = Comment::new("/* already block */".to_string(), "".to_string(), CommentStyle::Block);
...
fn test_format() {
    ...
    let block_comment = Comment::new("/* block */".to_string(), "".to_string(), CommentStyle::Block);
