//! Compiler interaction implementations for querying Rust type information
//!
//! This module contains different strategies for extracting type information
//! from Rust code:
//! - RustdocQuerier: Uses rustdoc JSON output
//! - SynQuerier: Uses syn crate to parse Rust source files
...
impl SynQuerier {
    ...
    fn syn_type_to_signature(&self, ty: &syn::Type) -> RustTypeSignature {
        ...
        let parsed = super::RustTypeParser::parse(&raw).ok();
